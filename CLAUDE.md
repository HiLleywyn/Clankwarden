# Clankwarden -- Claude Code Guidelines

> This repo is the **Clankwarden** mod bot: the `.clank` scammer/bot
...
Clankwarden is a Discord containment + moderation bot (the `.clank` group, the
